...
elseif ThemePrefs.Get("MenuBG") == "Girls Band Party" then
  BG = "GBP"
elseif ThemePrefs.Get("MenuBG") == "Girls Band Party NEO" then
  BG = "GBP_CY"
elseif ThemePrefs.Get("MenuBG") == "Project Morfonica OS" then
  BG = "PMOS"
elseif ThemePrefs.Get("MenuBG") == "Starlight Stage" then
  BG = "CGSS"
elseif ThemePrefs.Get("MenuBG") == "Starlight Stage NEO" then
  BG = "CGSS_CY"
elseif ThemePrefs.Get("MenuBG") == "Million Live Theater Days [WIP]" then
  BG = "MLTD"
...
elseif ThemePrefs.Get("MenuBG") == "IIDX26 Rootage - DELABITY LABORATORY" then
  BG = "IIDX26 EVENT"
elseif ThemePrefs.Get("MenuBG") == "IIDX27 Heroric Verse" then
  BG = "IIDX27"
...
elseif ThemePrefs.Get("MenuBG") == "BeatStream" then
  BG = "BST"
elseif ThemePrefs.Get("MenuBG") == "Bombergirl" then
  BG = "BG"
