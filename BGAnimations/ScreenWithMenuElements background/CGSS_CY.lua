...
t[#t+1] = Def.ActorFrame {
  FOV=90;
     Def.Quad {
		...
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CGSS_CY/bg_anim_icon"))..{
		InitCommand=cmd(zoom,0.69;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y);
		OnCommand=cmd();
	};
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CGSS_CY/bg_anim_circle_00"))..{
		...
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CGSS_CY/bg_anim_circle_02"))..{
		...
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CGSS_CY/bg_anim_circle_01"))..{
		InitCommand=cmd(x,SCREEN_CENTER_X-395;y,SCREEN_CENTER_Y-240;diffusealpha,0.9;zoom,0.59;);
