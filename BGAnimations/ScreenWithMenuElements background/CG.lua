...
t[#t+1] = Def.ActorFrame {
  FOV=90;
	LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CG/_background"))..{
	...
	Def.Quad {
		...
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CG/_stars"))..{
		InitCommand=cmd(zoom,0.89;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y);
		OnCommand=cmd(texcoordvelocity,0.01,0;blend,'BlendMode_Add');
	};
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CG/Spotlight1"))..{
		...
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CG/Spotlight2"))..{
		...
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CG/Spotlight3"))..{
		...
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CG/_city"))..{
		InitCommand=cmd(zoom,0.69;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y+195);
		OnCommand=cmd(texcoordvelocity,0.02,0);
	};
		LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/CG/_code"))..{
